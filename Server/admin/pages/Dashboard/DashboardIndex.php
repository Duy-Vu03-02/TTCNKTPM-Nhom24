    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        <div class="app-main__inner">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tabs-eg-77">
                                    <div class="card widget-chart widget-chart2 text-left w-100 mb-3">
                                    ...
                                    <h6 class="text-muted text-uppercase font-size-md opacity-5 font-weight-normal">
                                        Top Authors</h6>
                                    <div class="scroll-area-sm h-auto">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card-shadow-success widget-chart widget-chart2 text-left card">
                        <div class="widget-content">
                            <div class="widget-content-outer">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left pr-2 fsize-1">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card-shadow-warning widget-chart widget-chart2 text-left card">
                        <div class="widget-content">
                            <div class="widget-content-outer">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left pr-2 fsize-1">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card-shadow-info widget-chart widget-chart2 text-left card">
                        <div class="widget-content">
                            <div class="widget-content-outer">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left pr-2 fsize-1">

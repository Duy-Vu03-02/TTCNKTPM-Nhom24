    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                <form id="orderForm" method="POST" action="pages/Question/QuestionLogic.php?id=<?php echo $row['id']; ?>&chapterId=<?php echo $chapterId ?>" enctype="multipart/form-data">
                    <table border="1" width="100%" padding="10px" style="border-collapse: collapse;">
                        <p class="p-4 m-0">
                            Bạn có chắc chắn muốn xóa câu hỏi này? <b><?php echo $row['code']; ?></b>
                        </p>
                    </table>

                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary pt-2 pb-2" data-bs-dismiss="modal">Hủy</button>
                        <button type="submit" class="btn btn-primary" name="deleteQuestion">Xác nhận</button>
                    </div>
                </form>
            </div>
        </div>
